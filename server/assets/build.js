...
/***/ function(module, exports, __webpack_require__) {
	...
	Vue.use(VueRouter)
	var PageA = Vue.extend(__webpack_require__(104));
	var PageB = Vue.extend(__webpack_require__(112));
	var App = Vue.extend({});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var id = "-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./pageA.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./pageA.vue","-!vue-html!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./pageA.vue"], function () {
	var newOptions = require("-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./pageA.vue")
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./pageA.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./pageA.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// webpack.ProvidePluginがないと以下を追加しないとjqueryが使えません
	// var $ = require('jquery');
	'use strict';
	...
	module.exports = {
	  ...
	  methods: {
	    getJson: function getJson(callback) {
	      var that = this;
	      $.ajax({
	        type: 'GET',
	        crossDomain: true,
...
/***/ function(module, exports) {
	...
	module.exports = "<h1 class=\"yellow\">apge A</h1>\n  <p>\n    this page is A!!! not B? ok?\n  </p>\n  <p>\n    msg = {{msg}}\n  </p>\n  <pre>\n    {{items | json 2}}\n  </pre>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./pageB.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./pageB.vue","-!vue-html!./../../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./pageB.vue"], function () {
	var newOptions = require("-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./pageB.vue")
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./pageB.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./pageB.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "<h1 class=\"blue\">apge B</h1>\n  <p>\n    this page is B!!!\n  </p>\n  <p>\n    msg = {{msg}}\n  </p>";
